#!/usr/bin/env python3
"""
scripts/run_cuad_evaluation.py
------------------------------
Automated CUAD 100-PDF Benchmark Evaluation Runner for LeaseSight.

Pipeline Steps:
1. Parse layout & extract text for each benchmark PDF.
...
8. Export raw JSON to data/cuad_benchmark_results.json & report to CUAD_100_BENCHMARK_REPORT.md
"""
...
def evaluate_cuad_benchmark():
    print("=========================================================================")
    print("         LeaseSight CUAD 100-PDF Benchmark Evaluation Pipeline           ")
    print("=========================================================================")
    ...
    print("--- Starting Benchmark Evaluation across 100 Documents ---")
    ...
    benchmark_summary = {
        "benchmark_metadata": {
            "dataset_name": "CUAD (Contract Understanding Atticus Dataset) 100-PDF Sample",
            "random_seed": 42,
...
def generate_markdown_report(data: Dict[str, Any]):
    ...
    lines = [
        ...
        "",
        f"> **Evaluation Suite:** Un-cached CUAD 100-PDF Benchmark  ",
    ...
    lines.extend([
        ...
        "",
        "---",
        f"*Report generated automatically by `scripts/run_cuad_evaluation.py` on {time.strftime('%Y-%m-%d %H:%M:%S')}.*",
    ])
