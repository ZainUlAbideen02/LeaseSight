    ...
    'cells': [
        {
            ...
            'metadata': {},
            'source': [
                '# LeaseSight Standalone 10-CUAD Ablation & Evaluation Notebook\n',
                '\n',
                'This Jupyter Notebook runs a standalone ablation study comparing the **Full LeaseSight Engine** against 3 structural RAG baselines on commercial contract datasets across 10 Core CUAD categories.\n',
                '\n',
        ...
        },
        {
            'cell_type': 'markdown',
            'metadata': {},
            'source': ['## Cell 4: 10-CUAD Category Variations Implementation']
        },
        {
            'cell_type': 'code',
            'execution_count': None,
            ...
            'outputs': [],
            'source': [
                '# Cell 4: 10-CUAD Category Variations Implementation\n',
                'import re\n',
                'import numpy as np\n',
                ...
                '\n',
                'print("10-CUAD ablation search variations configured successfully.")'
            ]
        },
        {
            'cell_type': 'markdown',
            'metadata': {},
            'source': ['## Cell 5: Execution Loop & Academic Metric Calculation (HR@5, P@1, MRR)']
        },
        {
            'cell_type': 'code',
            'execution_count': None,
            ...
            'outputs': [],
            'source': [
                '# Cell 5: Execution Loop & Metric Calculation (HR@5, P@1, MRR)\n',
                'import time\n',
                '\n',
                ...
                'print(f"Running evaluation benchmark on {len(pdf_files)} PDF files across 10 CUAD categories...")\n',
                '\n',
                'variants = {\n',
                '    "full_leasesight": {\n',
        ...
        },
        {
            'cell_type': 'markdown',
            'metadata': {},
            'source': ['## Cell 6: LaTeX Table & Markdown Report Generator (HR@5, P@1, MRR)']
        },
        {
            'cell_type': 'code',
            'execution_count': None,
            ...
            'source': [
                ...
                '    p1_avg = (v_info["p1_cnt"] / float(total_queries)) * 100.0 if total_queries > 0 else 0.0\n',
                '    mrr_avg = v_info["mrr_sum"] / float(total_queries) if total_queries > 0 else 0.0\n',
                ...
                'print("=========================================================================")\n',
                'md_table = """| RAG Pipeline Variation | HR@5 (%) | P@1 (%) | MRR | F1-Score | Faithfulness | Latency (s) |\n',
                '| :--- | :--- | :--- | :--- | :--- | :--- | :--- |"""\n',
                '\n',
                'for v_key, v in results_summary["variants"].items():\n',
                '    md_table += f"\\n| {v[\'name\']} | {v[\'hit_rate_at_5_percentage\']:.2f}% | {v[\'precision_at_1_percentage\']:.2f}% | {v[\'mrr\']:.4f} | {v[\'f1_score\']:.4f} | {v[\'faithfulness_percentage\']:.2f}% | {v[\'avg_latency_per_doc_seconds\']:.3f}s |"\n',
                '\n',
                'print(md_table)\n',
                '\n',
                'print("\\n=========================================================================")\n',
                ...
                '    latex_table += f"\\n{name} & {hr} & {p1} & {mrr} & {f1} & {v[\'faithfulness_percentage\']:.2f} & {v[\'avg_latency_per_doc_seconds\']:.3f} \\\\\\\\"\n',
                '\n',
                'latex_table += r"""\n',
                '\\hline\n',
                '\\end{tabular}\n',
...
print('Notebook successfully updated at:', out_path)
